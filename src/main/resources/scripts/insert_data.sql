...
INSERT INTO account (id, email, password, first_name, middle_name, last_name, gender, phone_number, birth_date, status, created, updated, location_id)
             VALUES (6000, 'owed@user.com', '$2a$04$IV55Yhr.ICvWxGm/6hj8iua3gium/Yzyg0XBE8Nb2q1BvEzG21RiK', 'firstName', 'middleName', 'lastName', 'MALE', '123456789', current_date, 'REGISTERED', current_timestamp, current_timestamp, null);

INSERT INTO account (id, email, password, first_name, middle_name, last_name, gender, phone_number, birth_date, status, created, updated, location_id)
             VALUES (7000, 'owner@user.com', '$2a$04$IV55Yhr.ICvWxGm/6hj8iua3gium/Yzyg0XBE8Nb2q1BvEzG21RiK', 'firstName', 'middleName', 'lastName', 'MALE', '123456789', current_date, 'REGISTERED', current_timestamp, current_timestamp, null);
...
INSERT INTO bill (id, name, responsible, creator, status, created, updated, category, company, occurrence, tip_percent,
                  tip_amount, split_by, location_id, active)
VALUES (1004, 'test', 7000, 7000, 'OPEN', current_timestamp, current_timestamp, null, null, 0, 15, null, 'ITEM', null,
        1);
...
INSERT INTO bills_vs_accounts (bill_id, account_id, percentage, status) VALUES (1003, 5000, 100, 'ACCEPTED');
INSERT INTO bills_vs_accounts (bill_id, account_id, percentage, status) VALUES (1004, 6000, 100, 'ACCEPTED');
INSERT INTO bills_vs_accounts (bill_id, account_id, percentage, status) VALUES (1004, 7000, 100, 'ACCEPTED');
...
INSERT INTO item (id, bill_id, name, cost) VALUES (1004, 1003, 'culeros', 69.00);
INSERT INTO item (id, bill_id, name, cost) VALUES (1005, 1004, 'nintendo switch', 400.00);
...
INSERT INTO items_vs_accounts (item_id, account_id, percentage) VALUES (1004, 5000, 100.0);
INSERT INTO items_vs_accounts (item_id, account_id, percentage) VALUES (1005, 6000, 100.0);
