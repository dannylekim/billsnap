...
public class NotificationController {
    ...
    @Autowired
    public NotificationController(final NotificationFacade notificationFacade, BillMapper billMapper) {
    ...
    public BillSplitResource answerInvitation(@Parameter(required = true, name = "invitationId", description = "invitation ID")
        ...
        final var billSplitDTO = notificationFacade.answerInvitation(new AnswerNotificationDTO(invitationId, answerInvitationResource.getAnswer(), principal.getName()));

        if (answerInvitationResource.getAnswer()) {
